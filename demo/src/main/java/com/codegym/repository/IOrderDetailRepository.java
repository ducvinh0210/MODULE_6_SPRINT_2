...
public interface IOrderDetailRepository extends JpaRepository<OrderDetail, Integer> {
    ...
    @Query(value = "select order_detail.id as id, product.name as name, `size`.name as size , product.price as price , product.discount as discount, order_detail.quantity as quantity, product.image as image, product_size.quantity as quantityProduct" +
